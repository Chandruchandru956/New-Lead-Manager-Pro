...
import { 
  Bell, Moon, Sun, Download, Trash2, ShieldAlert, User, Laptop
} from "lucide-react";
import {
  AlertDialog,
  AlertDialogAction,
      ...
      >
        ...
        <Card className="rounded-2xl shadow-sm border-t-4 border-t-primary overflow-hidden">
          <CardHeader className="bg-muted/10 border-b pb-6">
            ...
            <CardDescription>Manage your account identity and preferences.</CardDescription>
          </CardHeader>
          <CardContent className="pt-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
              ...
              <Button variant="outline" className="font-semibold shadow-sm shrink-0">Edit Profile</Button>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="rounded-2xl shadow-sm border-destructive/20 h-fit overflow-hidden">
          <CardHeader className="bg-destructive/5 pb-4 border-b border-destructive/10">
            ...
            <CardDescription>Export your data or permanently delete your account info.</CardDescription>
          </CardHeader>
          <CardContent className="pt-6 space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                <h4 className="text-sm font-semibold text-foreground">Export Pipeline Data</h4>
                <p className="text-xs text-muted-foreground mt-1 max-w-sm">Download all your leads, notes, and stages as a CSV file for backup or analysis.</p>
              </div>
            ...
            <div className="pt-6 border-t flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1 max-w-sm">Permanently delete all leads and CRM data. This action cannot be undone.</p>
              </div>
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  ...
                  <AlertDialogFooter>
                    ...
                    <AlertDialogAction onClick={handleClearData} className="bg-destructive hover:bg-destructive/90 text-destructive-foreground font-semibold">
